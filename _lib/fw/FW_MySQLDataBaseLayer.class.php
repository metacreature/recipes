...
/**
 * FW_MySQLDataBaseLayer
 * - handles the database-conection
 * - provides many standard-features and actions like showTables() or getAssocResults()
 * - automatic unlock tables before shutdown
 * - can print and save querylogs depending on the settings even automatic
 * @author Clemens Köhler
 * @copyright Copyright (c) 2010, Clemens Köhler
 * @todo dumpDBData not started
 */
